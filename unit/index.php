...
?>
<section id="unitDetail" class="py-10 bg-neutral-50">
    ...
    <div class="unit-detail-header">
      <div class="container">
        <div class="project-logo-wrapper w-full">
          <img src="<?= getProjectLogo($unit_detail['projectID']) ?>" alt="<?= $projectName ?>" class="w-[160px]">
        </div>
        <div class="show-unit-wrapper flex">
          <div class="show-unit-left w-3/5 py-5">
          ...
          <div class="show-unit-right w-2/5 bg-white shadow rounded p-10 flex flex-col justify-between">
            ...
            <div class="price-box text-xl flex flex-col gap-2">
              ...
              <div class="h-4"></div>
              <button class="btn btn-accent w-full h-fit text-2xl text-white font-medium px-10 py-5">
                สนใจยูนิตนี้
              </button>
            </div>
          </div>
    ...
    <div class="h-15"></div>
    <div id="projectDetail" class="bg-primary flex">
      <div class="w-1/2 aspect-[4/3] bg-cover bg-center" style="background-image: url(<?= getImagePath($project['headerImage']['resource']['filePath']) ?>);"></div>
    ...
    <div id="unitGallery" class="py-20">
      <div class="container">
