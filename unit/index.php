  ...
  <div class="unit-detail-header">
    <div class="container">
      ...
      <div class="show-unit-wrapper flex flex-col md:flex-row">
        ...
        <div class="show-unit-right w-full md:w-2/5 bg-white shadow-lg md:shadow rounded-t-xl rounded-b-md md:rounded p-5 md:p-10 flex flex-col justify-between -mt-10 md:mt-0 z-10">
