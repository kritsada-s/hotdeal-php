<div class="unit-box rounded-lg overflow-hidden shadow-lg border border-neutral-200 relative">
  <?php if ($unit['isSoldOut']) : ?>
    ...
    <span class="text-white text-[12px] lg:text-[16px] font-medium flex items-center justify-center px-5 py-2 w-full bg-red-500 rotate-45 absolute top-[20px] lg:top-[5%] left-[40px] lg:left-[30%] z-[3]">SOLD OUT</span>
  <?php endif; ?>
  <div class="unit-wrapper flex flex-col h-full <?= $unit['isSoldOut'] ? 'sold-out' : '' ?>">
    ...
    <div class="unit-detail px-2 py-3 lg:px-4 lg:pt-6 lg:pb-4 relative flex flex-col h-full justify-between">
      ...
      <div class="unit-info">
        ...
        <p>
          <span class="text-neutral-500 relative line-through text-[10px] lg:text-[16px] font-light">ปกติ <?= number_format($unit['sellingPrice']/1000000, 2, '.', '') ?> ล้าน</span>
        </p>
